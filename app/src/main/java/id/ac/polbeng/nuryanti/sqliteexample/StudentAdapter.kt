package id.ac.polbeng.nuryanti.sqliteexample

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import id.ac.polbeng.nuryanti.sqliteexample.databinding.ItemListStudentBinding

class StudentAdapter
    (private val studentList: ArrayList<StudentModel>): RecyclerView.Adapter<StudentAdapter.ListViewHolder>() {
